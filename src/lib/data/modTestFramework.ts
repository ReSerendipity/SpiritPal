...
import type { SpiritPalPluginContext, PluginUI, PluginPets, PluginAudio, PluginEvents, PluginSchedule, PluginStorage, PluginNet, PluginAI, PluginVoice } from '@/lib/system/pluginSdk'
