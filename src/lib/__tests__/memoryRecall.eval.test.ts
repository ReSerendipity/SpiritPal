 ...
 *
 * 45 条「记忆 → 查询 → 期望命中关键词」评测用例，验证检索链路的召回质量。
...
const CASES: EvalCase[] = [
  ...
  // ===== P2-3：新增 15 条（31-45）——覆盖工作/家庭/健康/技能/宠物/偏好等真实场景 =====
  { id: 31, memory: '我养的第一只宠物是一只白色的小狗', query: '我的第一只宠物是什么', expect: '小狗' },
  { id: 32, memory: '我在上海工作，从事金融行业', query: '我在哪个城市工作', expect: '上海' },
  { id: 33, memory: '我平时喜欢喝绿茶，不爱喝奶茶', query: '我喜欢喝什么茶', expect: '绿茶' },
  { id: 34, memory: '我有个坏习惯是熬夜刷手机', query: '我的坏习惯是什么', expect: '熬夜' },
  { id: 35, memory: '我最近在减肥，晚上不吃主食', query: '我最近在做什么', expect: '减肥' },
  { id: 36, memory: '我家楼下有一条流浪猫', query: '我家楼下有什么', expect: '流浪猫' },
  { id: 37, memory: '我会弹钢琴，考过八级', query: '我会什么乐器', expect: '钢琴' },
  { id: 38, memory: '我的父亲是一名医生', query: '我爸爸做什么工作', expect: '医生' },
  { id: 39, memory: '我每周六去游泳', query: '我周末做什么运动', expect: '游泳' },
  { id: 40, memory: '我最近迷上了烘焙，周末做蛋糕', query: '我最近有什么爱好', expect: '烘焙' },
  { id: 41, memory: '我养了一只仓鼠叫毛毛', query: '我的仓鼠叫什么', expect: '毛毛' },
  { id: 42, memory: '我最爱的甜品是提拉米苏', query: '我最爱吃什么甜品', expect: '提拉米苏' },
  { id: 43, memory: '我在练习英语口语，每天半小时', query: '我在练习什么', expect: '英语' },
  { id: 44, memory: '我明年准备去新疆旅行', query: '我明年计划去哪', expect: '新疆' },
  { id: 45, memory: '我喜欢蓝色，房间窗帘都是蓝色系', query: '我喜欢什么颜色', expect: '蓝色' },
]

describe('B-4-3：记忆召回评测集（45 条）', () => {
  let hits = 0
  const misses: number[] = []
