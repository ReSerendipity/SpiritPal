...
} from '@/lib/system/windowTitleExtractor'
...
// P1-1: 导出窗口信息相关类型和函数
export type { WindowInfo, ExtractedWindowInfo } from '@/lib/system/windowTitleExtractor'
export { getWindowTitleExtractor } from '@/lib/system/windowTitleExtractor'
