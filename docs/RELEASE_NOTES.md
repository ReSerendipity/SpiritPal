...
| # | 事项 | 状态 |
|---|---|---|
| 1 | 自动更新决策：2026-09-04 曾关闭（端点 `spiritpal/spiritpal-app` 404 死链）；**2026-09-10 起重新启用**（commit `f9e0f43`：`plugins.updater.active=true` + `createUpdaterArtifacts=true`，endpoints 修正为 ReSerendipity/SpiritPal，对应 P0-1.1）。当前状态：**已启用**，`updates.json` 随 v0.1.0 发布链维护（2026-09-15 核对）。 | 已重新启用 |
